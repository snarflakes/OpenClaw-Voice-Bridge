...
| --------------------- | -------- | ------------ | ----- | ------------------------------------ | ------------------ |
| openclaw-voice-bridge | high     | dynamic-tool | -     | definePluginEntry, registerHttpRoute | tools              |
...
| --------------------- | ---------------------- | ----- | ------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ------------- |
| openclaw-voice-bridge | seam-inventory         | log   | observed 0 hooks, 2 registrations, and 1 manifest contracts                           | registration:definePluginEntry, registration:registerHttpRoute, manifestContract:tools | -             |
| openclaw-voice-bridge | hook-names-present     | log   | all observed hooks exist in the target OpenClaw hook registry                         | -                                                                                      | -             |
| openclaw-voice-bridge | api-registrars-present | log   | all observed api.register* calls exist in the target OpenClaw plugin API builder      | registerHttpRoute                                                                      | -             |
| openclaw-voice-bridge | sdk-exports-present    | log   | all observed plugin SDK imports exist in target OpenClaw package exports              | openclaw/plugin-sdk/plugin-entry                                                       | -             |
| openclaw-voice-bridge | package-metadata       | log   | selected package metadata for plugin contract checks                                  | package.json, openclaw-voice-bridge, version:1.2.1                                     | -             |
| openclaw-voice-bridge | declarative-contracts  | log   | fixture declares manifest contracts that can be checked without executing plugin code | tools                                                                                  | -             |
